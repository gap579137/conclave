...
2. **GitHub**: Use [GitHub Security Advisories](https://github.com/theonlyhennygod/conclave/security/advisories/new)
...
Conclave implements defense-in-depth security:
...
Conclave Docker images follow CIS Docker Benchmark best practices:
...
docker inspect --format='{{.Config.User}}' conclave
# Expected: 65534:65534

# Run with read-only filesystem (production hardening)
docker run --read-only -v /path/to/workspace:/workspace conclave gateway
```
