# Conclave ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for Conclave edge scenarios on ESP32.
...
3. Connect UI state with Conclave edge/runtime messaging
...
- [Conclave Hardware Design](../../docs/hardware-peripherals-design.md)
