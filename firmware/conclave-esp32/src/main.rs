//! Conclave ESP32 firmware — JSON-over-serial peripheral.
//!
//! Listens for newline-delimited JSON commands on UART0, executes gpio_read/gpio_write,
//! responds with JSON. Compatible with host Conclave SerialPeripheral protocol.
//!
...
fn main() -> anyhow::Result<()> {
    ...
    info!("Conclave ESP32 firmware ready on UART0 (115200)");
