//! Example: Implementing a custom Memory backend for Conclave
//!
...
// ── Re-define the trait types (in your app, import from conclave::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 Conclave Memory Demo — InMemoryBackend\n");
