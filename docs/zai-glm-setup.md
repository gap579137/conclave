...
Conclave supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current Conclave provider behavior.

## Overview

Conclave supports these Z.AI aliases and endpoints out of the box:
...
### Test with Conclave CLI

```bash
# Test agent directly
echo "Hello" | conclave agent
