# Conclave PR Workflow (High-Volume Collaboration)

This document defines how Conclave handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to Conclave/project-native labels.
...
- Confirm any required identity-like wording uses Conclave/project-native terminology.
