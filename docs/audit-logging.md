...
## Problem
Conclave logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/conclave/audit.key"
...
conclave audit --user @alice

# Show all high-risk commands
conclave audit --risk high

# Show violations from last 24 hours
conclave audit --since 24h --violations-only

# Export to JSON for analysis
conclave audit --format json --output audit.json
