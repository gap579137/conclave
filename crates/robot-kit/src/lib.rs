//! # Conclave Robot Kit
//!
//! A standalone robotics toolkit that integrates with Conclave for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Conclave AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use conclave_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Conclave. It defines its own
//! `Tool` trait that is compatible with Conclave's but doesn't require it.
//!
//! ## Safety
//!
