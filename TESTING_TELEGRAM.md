...
This guide covers testing the Telegram channel integration for Conclave.
...
Solution: Check user allowlist
  ...
  4. Run: conclave onboard --channels-only
```
...
| ---------------------- | ---------- | -------------------------------- |
| Health check time      | <5s        | `time conclave channel doctor`   |
...
```bash
# Maximum logging
RUST_LOG=trace conclave channel start
...
# Validate config
cat ~/.conclave/config.toml | grep -A 3 "\[channels_config.telegram\]"
```
...
- [Conclave Main README](README.md)
- [Contributing Guide](CONTRIBUTING.md)
- [Issue Tracker](https://github.com/theonlyhennygod/conclave/issues)
