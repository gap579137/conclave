"""
Tests for conclave-tools package.
"""
...
def test_cli_allows_interactive_without_message():
    ...
    from conclave_tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from conclave_tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from conclave_tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from conclave_tools import file_read, file_write
