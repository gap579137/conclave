"""
Discord bot integration for Conclave.
"""
...
class DiscordBot:
    """
    Discord bot powered by Conclave agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install conclave-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"Conclave Discord Bot ready: {self.client.user}")
