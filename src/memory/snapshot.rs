...
const SNAPSHOT_HEADER: &str = "# 🧠 Conclave Memory Snapshot\n\n\
    > Auto-generated by Conclave. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 Conclave Memory Snapshot

> Auto-generated by Conclave.
...
I am Conclave, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 Conclave Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
